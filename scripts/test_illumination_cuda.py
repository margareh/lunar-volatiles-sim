...
if __name__ == "__main__":
    ...
    # original model
    # ax[0,0].imshow(illumin_frac_old, vmin=0, vmax=1, cmap='inferno')
    # ax[0,1].imshow(psr_old, vmin=0, vmax=1, cmap='gray')
    ax[0,0].set_title('Illumination, Original')
    ax[0,1].set_title('PSRs, Original')

    # new model
    ax[1,0].imshow(illumin_frac, vmin=0, vmax=1, cmap='inferno')
    ax[1,1].imshow(psr, vmin=0, vmax=1, cmap='gray')
    ax[0,0].set_title('Illumination, CUDA')
    ax[0,1].set_title('PSRs, CUDA')
