...
class LvSim():
    ...
    def save(self):
        ...
        np.savez_compressed(os.path.join(self.cfg.args.outpath, 'maps_'+ts+'.npz'), surface=self.surface, illumin_frac=self.illumin_frac, psr=self.psr, age=self.surface_age, det1=self.det1, det2=self.det2)
